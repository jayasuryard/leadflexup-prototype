...
export const WebsiteBuilder = () => {
  ...
  return (
    <Commentable id="website-builder" label="Website Builder">
    <div className="h-[calc(100vh-7rem)] flex flex-col">
      {/* Header */}
      <Commentable id="website-builder-header" label="Website Builder Header">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          {/* View Mode Toggle */}
          <Commentable id="website-builder-view-toggle" label="Desktop/Mobile View Toggle">
          ...
          <Commentable id="website-builder-request-changes-btn" label="Request Changes Button">
          <button
      ...
      {/* Browser Window */}
      <Commentable id="website-builder-browser-preview" label="Website Browser Preview">
      <div className="flex-1 bg-white rounded-xl border border-navy-100 overflow-hidden flex flex-col min-h-0">
        {/* Browser Chrome */}
        <Commentable id="website-builder-browser-chrome" label="Browser Chrome Bar">
        ...
        <div className={`flex-1 overflow-y-auto ${viewMode === 'mobile' ? 'flex justify-center p-6 bg-navy-100' : ''}`}>
          <div className={viewMode === 'mobile' ? 'w-[375px] bg-white rounded-2xl overflow-hidden shadow-xl border border-navy-200' : 'w-full'}>
            ...
            {/* Hero */}
            <Commentable id="website-builder-hero-section" label="Website Hero Section">
            ...
            {/* Services */}
            <Commentable id="website-builder-services-section" label="Website Services Section">
            ...
            {/* Gallery */}
            <Commentable id="website-builder-gallery-section" label="Website Gallery Section">
            <div className="py-10 px-6">
            ...
            {/* Contact */}
            <Commentable id="website-builder-contact-section" label="Website Contact Section">
            <div className="py-10 px-6 bg-navy-50">
      ...
      <Commentable id="website-builder-request-popup" label="Request Changes Popup">
      <AnimatePresence>
        {showRequestPopup && (
          <motion.div
            initial={{ opacity: 0 }}
