...
import {
  ...
  Check, Crown, ChevronDown, MessageSquare, Layers, PieChart, Mic,
  Send, Languages
} from 'lucide-react';
...
/* ─── Voice Input Modal ─── */
const VoiceInputModal = ({ open, onClose, onTranscript, language }) => {
...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#a8c5e0] via-[#c0d9ee] to-[#e8f0f7] relative overflow-hidden">
      ...
      {/* ═══ HERO SECTION ═══ */}
      <section className="relative max-w-10xl max-h-max mx-auto px-4 pt-24 pb-20 text-center">
        {/* Hero Background Image */}
        <div className="absolute inset-0 pointer-events-none rounded-3xl overflow-hidden mt-[-100px] max-h-[1000px]">
          <div 
        ...
        >
          {/* Main Headline - Inspired by "Anything" design */}
          <h1 className="text-7xl sm:text-8xl md:text-9xl font-light text-white tracking-tight mb-8 italic">
            LeadFlexUp
          </h1>
          ...
          >
            {!isAnalyzing ? (
              <form onSubmit={handleOnboard} className="relative">
        ...
        {/* Decorative Image (Optional - like the reference) */}
        <motion.div
        ...
        >
          {/* You can add a decorative image here similar to the Mac in the reference */}
        </motion.div>
      </section>
