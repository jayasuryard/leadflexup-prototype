  ...
  return (
    <section id="pricing" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Commentable id="pricing-heading" label="Pricing Section Heading">
        ...
        <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto">
          {subscriptionPlans.map((plan, i) => {
            ...
            return (
              <Commentable key={plan.id} id={`pricing-plan-${plan.id}`} label={`Pricing Plan: ${plan.id}`}>
                <motion.div {...cardFade(i)} className="relative">
                  {plan.recommended && (
